...
<meta property="og:title" content="My Citation | CONNEXION" />
...
<body>
 <nav class="navigation">
    ...
    <div class="centreur">
     <div class="titre"> <h1 class="title">Connexion</h1></div>
		<p class="description">Connectez-vous pour accéder à l'entièreté du site!</p>

    <?php if (isset($error)) : ?>
      <p><?php echo $error; ?></p>
    <?php endif; ?>
    <form method="post" action="in/connexion.php"  style="text-align: center;">
